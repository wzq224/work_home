package wang.nonn.helloworld.ui;

import java.util.Date;

import wang.nonn.helloworld.model.Customer;
import wang.nonn.helloworld.util.DatabaseUtils;
 ...
 * parameter <code>bordertech.wcomponents.lde.component.to.launch=wang.nonn.helloworld</code>
